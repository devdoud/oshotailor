...
class OTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle().copyWith(fontSize: 41.0, fontWeight: FontWeight.bold, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
      headlineLarge: const TextStyle().copyWith(fontSize: 41.0, fontWeight: FontWeight.bold, color: Colors.white),
